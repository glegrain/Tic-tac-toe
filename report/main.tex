...
The chip will have a total of 31 I/O pins plus 5 GND pins and 4 VDD pins.
...
\begin{figure}
\centering
\includegraphics[width=.9\textwidth]{pinout}
...
\begin{figure}
\centering
\includegraphics[width=.9\textwidth]{chipsize}
